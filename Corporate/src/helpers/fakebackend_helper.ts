...
// Login Method
export const postFakeLogin = (data: any) => api.post(url.POST_LOGIN, data);
...
export const postJwtLogin = (data: any) =>
  api.post(url.POST_FAKE_JWT_LOGIN, data);
...
export const loadCategoriesApi = () => api.get(url.GET_CATEGORIES);
export const loadLocationsApi = () => api.get(url.GET_LOCATIONS);
export const loadDepartmentsApi = () => api.get(url.GET_DEPARTMENTS);
export const loadUsersApi = () => api.get(url.GET_USERS);
export const createAssetApi = (asset: any) =>
  api.post(url.ADD_NEW_ASSET, asset);
...
export const addNewProduct = (product: any) =>
  api.post(url.ADD_NEW_PRODUCT, product);
// update Products
export const updateProduct = (product: any) =>
  api.put(url.UPDATE_PRODUCT, product);
...
export const addNewCustomer = (customer: any) =>
  api.post(url.ADD_NEW_CUSTOMER, customer);
...
// update Task
export const updateTask = (task: any) => api.put(url.UPDATE_TASK, task);
...
export const addNewContact = (contact: any) =>
  api.post(url.ADD_NEW_CONTACT, contact);

// update Contact
export const updateContact = (contact: any) =>
  api.put(url.UPDATE_CONTACT, contact);
...
export const addNewCompanies = (company: any) =>
  api.post(url.ADD_NEW_COMPANIES, company);

// update Companies
export const updateCompanies = (company: any) =>
  api.put(url.UPDATE_COMPANIES, company);
...
// update Lead
export const updateLead = (lead: any) => api.put(url.UPDATE_LEAD, lead);
...
export const addNewInvoice = (invoice: any) =>
  api.post(url.ADD_NEW_INVOICE, invoice);

// update Invoice
export const updateInvoice = (invoice: any) =>
  api.put(url.UPDATE_INVOICE + "/" + invoice._id, invoice);
...
export const addNewTicket = (ticket: any) =>
  api.post(url.ADD_NEW_TICKET, ticket);

// update Tickets
export const updateTicket = (ticket: any) => api.put(url.UPDATE_TICKET, ticket);
...
export const addProjectList = (project: any) =>
  api.post(url.ADD_NEW_PROJECT, project);
...
export const addNewFolder = (folder: any) =>
  api.post(url.ADD_NEW_FOLDER, folder);
...
export const addNewProject = (project: any) =>
  api.post(url.ADD_NEW_TODO_PROJECT, project);
...
export const addNewJobApplicationList = (job: any) =>
  api.post(url.ADD_NEW_APPLICATION_LIST, job);
...
export const addJobCandidate = (candidate: any) =>
  api.post(url.ADD_NEW_CANDIDATE, candidate);
export const updateJobCandidate = (candidate: any) =>
  api.put(url.UPDATE_CANDIDATE, candidate);
